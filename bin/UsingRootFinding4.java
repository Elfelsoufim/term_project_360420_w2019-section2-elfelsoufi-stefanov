...
public class UsingRootFinding4
{
	...
	public static final int numbdays = 30;																// Sets the number of days that the simulation will run
	...
	**/
	public static void main(String[] args)
	{
		...
		double froot = 0;
		int i = 0;
		upperPoint = upperBound;	//these numbers represent the pumping power when evaluating the function
...
//to calculate the trendline, please ignore it is not finished yet
		...
		//array with stored data, see method for more info
		Voltower = storeData(root, numbdaysdbl, numbhousesdbl);
